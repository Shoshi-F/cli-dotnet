...
//    try
//    {
//        //איתחול רשימת נתיבים של קבצי הקוד שנמצאו 
//        List<string> codeFiles = new List<string>();
//        //אופציה לאריזת כל הקבצים של כל השפות
//        if (languages[0] == "all")
//            codeFiles.AddRange(Directory.GetFiles(".\\", "*", SearchOption.AllDirectories));
//        //אם המשתמש ביקש שפות מסוימות הלולאה עוברת על הקבצים ומכניסה רק את הקבצים בשפות המבוקשות
...
//        //אם לא נמצאו קבצים כלל בניתוב המבוקש
...
//        }
//        //פותח את קובץ ה-output לכתיבת קבצי הקוד לקובץ אחד
//        using (var outputFile = File.CreateText(output.FullName))
//        {
//            //outputFile.WriteLine("bundle");
//            outputFile.WriteLine("// Author: " + author);
//            foreach (var file in codeFiles)
//            {
//                //אם אפשרות ההערה פעילה מוסיף הערה עם שם הקובץ וניתובו
//                if (note != null)
//                {
...
//                }
//                //קורא את כל התוכן של הקובץ הנוכחי למשתנה מחרוזת בשם fileContent
//                var fileContent = File.ReadAllText(file);
//                if (removeEmptyLines)
//                {
//                    fileContent = string.Join("", fileContent.Split('\n').Where(line => !string.IsNullOrWhiteSpace(line)));
//                }
//                //כותב את התוכן המעובד של הקובץ הנוכחי לקובץ הפלט
